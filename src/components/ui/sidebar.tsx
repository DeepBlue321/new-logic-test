      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              'group/sidebar-wrapper gap-9 flex min-h-svh  w-full has-[[data-variant=inset]]:bg-sidebar',
              className
            )}
            ref={ref}
            {...props}
...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md:block text-sidebar-foreground w-fit flex-none "
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            'duration-200 fixed inset-y-0 z-10 hidden h-svh static w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex',
            side === 'left'
